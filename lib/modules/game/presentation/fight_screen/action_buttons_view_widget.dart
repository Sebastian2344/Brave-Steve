    ...
    if (widget.isNewGame) {
      SchedulerBinding.instance.addPostFrameCallback((_) {
        ...
        ShowCaseWidget.of(context).startShowCase([
          ...
          widget.keyLegacy,// 4. prestiż
          _keyAtak, // 5. Atak
          _keySuperAtak, // 6. SuperAtak
          _keyOslabienie, // 7. Osłabienie
          _keyOczyszczenie, // 8. Oczyszczenie
        ]);
      });
    }
  }
